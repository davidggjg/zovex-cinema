...
export default function DetailView({ item, onBack, onPlay }) {
  ...
  return (
    <div style={{ 
      ...
      direction: 'rtl',
      position: 'relative',
      zIndex: 100, // מבטיח שזה מעל הכל
      paddingBottom: '100px' // רווח בטחון למטה
    }}>
      ...
      <div style={{ padding: '40px 5%' }}>
        ...
        {/* כפתור הנגן - לא נגענו בו! */}
        <button 
          onClick={handlePlayClick}
          style={{ 
            padding: '12px 35px', fontSize: '20px', fontWeight: 'bold', 
            background: '#e50914', color: '#fff', border: 'none', 
            borderRadius: '4px', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '10px'
          }}
        >
      ...
      {/* ה"חוסם": מוודא ששום דבר מלמטה לא "נדחף" למעלה */}
