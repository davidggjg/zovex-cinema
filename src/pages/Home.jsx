  ...
  return (
    <div style={{ background: "#fff", minHeight: "100vh", direction: "rtl", fontFamily: "Arial, sans-serif" }}>
      ...
      <header style={{ padding: "14px 14px 0", position: "sticky", top: 0, background: "#fff", zIndex: 100, boxShadow: "0 2px 10px rgba(0,0,0,.08)" }}>
        <div style={{ overflow: "hidden", maxHeight: showCategories ? 60 : 0, opacity: showCategories ? 1 : 0, transition: "max-height 0.2s ease, opacity 0.2s ease", marginBottom: showCategories ? 12 : 0 }}>
        ...
        <div style={{ overflow: "hidden", maxHeight: showCategories ? 200 : 0, opacity: showCategories ? 1 : 0, transition: "max-height 0.2s ease, opacity 0.2s ease" }}>
